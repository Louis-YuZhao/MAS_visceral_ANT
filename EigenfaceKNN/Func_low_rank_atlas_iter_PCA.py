...
def rpca(Y,lamda, tol=1e-07) :
# referenceImName: referenceImage dir

#    t_begin = time.clock()
#    
    gamma = lamda* np.sqrt(float(Y.shape[1])/Y.shape[0])
    low_rank, sparse, n_iter, rank, sparsity, sumSparse= ialm.recover(Y, gamma, tol)
    gc.collect()   
...
def saveImagesFromDM(dataMatrix,outputPrefix,referenceImName, extension):
    im_ref = sitk.ReadImage(referenceImName)
    im_ref_array = sitk.GetArrayFromImage(im_ref) # get numpy array
    z_dim, x_dim, y_dim = im_ref_array.shape # get 3D volume shape
    num_of_data = dataMatrix.shape[1]
    for i in range(num_of_data):
        ...
        fn = outputPrefix + str(i) + extension
...
EXE_BRAINSFit = '/home/louis/Documents/program_work/BRAINSTools_build/bin/BRAINSFit'
def AffineReg(fixedIm,movingIm,outputIm, outputTransform = None):
    ...
    result_folder = os.path.dirname(movingIm)  #os.path.dirname(path) : 
...
--movingVolumeTimeIndex 0 --medianFilterSize 0,0,0 --removeIntensityOutliers 0 --ROIAutoDilateSize 0 --ROIAutoClosingSize 9 --relaxationFactor 0.5 --maximumStepLength 0.2 \
...
--projectedGradientTolerance 1e-05 --costMetric MMI'
    ...
    tempFile = open(result_folder+'/affine_reg.log', 'w') # open and creat a file
    process = subprocess.Popen(cmd, stdout=tempFile, shell=True) #The subprocess module 
...
EXE_ANTS = '/home/louis/Documents/Python/ANTs-build/bin/antsRegistration'
...
EXE_WarpImageMultiTransform = '/home/louis/Documents/Python/ANTs-build/bin/WarpImageMultiTransform'
...
EXE_CreateJacobianDeterminantImage = '/home/louis/Documents/Python/ANTs-build/bin/CreateJacobianDeterminantImage'
...
EXE_BRAINSDemonWarp ='/home/louis/Documents/Python/Slicer-4.5.0-1/lib/Slicer-4.5/cli-modules/BRAINSDemonWarp'
...
EXE_BSplineDeformableRegistration = '/home/louis/Documents/Python/Slicer-4.5.0-1/lib/Slicer-4.5/cli-modules/BSplineDeformableRegistration'
...
EXE_BSplineToDeformationField = '/home/louis/Documents/Python/Slicer-4.5.0-1/lib/Slicer-4.5/cli-modules/BSplineToDeformationField'
...
EXE_WarpImageMultiTransform = '/home/louis/Documents/program_work/BRAINSTools_build/bin/WarpImageMultiTransform'
...
EXE_ComposeMultiTransform = '/home/louis/Documents/program_work/BRAINSTools_build/bin/ComposeMultiTransform'
...
EXE_BRAINSResample = '/home/louis/Documents/program_work/BRAINSTools_build/bin/BRAINSResample'
...
EXE_AverageImages ='/home/louis/Documents/program_work/BRAINSTools_build/bin/AverageImages'
...
EXE_InvertDeformationField = '/home/louis/Documents/Python/ITKUtils_build/InvertDeformationField '
