...
if OrganPatch == True:
    result_dir_pre   = root_dir + '/'+organ + '_'+ regIfLinear + '/PCA_predict'
elif LocalPatach == True:
    result_dir_pre   = root_dir + '/'+organ + '_'+ regIfLinear + '_LocalPatch'+ '/PCA_predict'
else:
...
if OrganPatch == True:
    RegOutput_dir   = root_dir + '/'+organ + '_'+ regIfLinear + '/PCA_predict'
elif LocalPatach == True:
    RegOutput_dir   = root_dir + '/'+organ + '_'+ regIfLinear + '_LocalPatch'+ '/PCA_predict'
else:
    raise ValueError('please choose the patch pattern')   
...
if OrganPatch == True:
    ...
    result_dir_true   = root_dir + '/'+organ + '_'+ regIfLinear + '_LocalPatch'+ '/PCA_test'
else:
    raise ValueError('please choose the patch pattern')  
