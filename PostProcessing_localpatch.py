...
rawPredictDir = root + "/Result_Eigenfaces_KNN/PatchedImage/"+organ + '_'+ regIfLinear +'_LocalPatch'+"/PCA_predict"
rawPredictlist = readTxtIntoList(rawPredictDir + "/FileListZoom.txt")

PredictDir = root + "/PredictRecovery/"+organ + '_'+ regIfLinear +'_LocalPatch' +"_PredictRecovery"
...
resultDir = root + "/UpsampleResult/"+organ + '_'+ regIfLinear + '_LocalPatch'+ "_UpsampleResult"
