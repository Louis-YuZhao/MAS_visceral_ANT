...
rootDir = '/media/louis/Volume/ProgramWorkResult/VisercialMAS_ANT/Full_Image/GC_label_adjustment/'

output_root_dir = '/media/louis/Volume/ProgramWorkResult/VisercialMAS_ANT'+'/MultiOrgan' + '_GT' + '/'
